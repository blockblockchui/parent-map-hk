...
export const locations50 = [
  ...
  {
    id: "002",
    name: "萊茲香港 (Ryze Hong Kong)",
    nameEn: "Ryze Hong Kong",
    category: "playhouse",
    district: "鰂魚涌",
    region: "hk-island",
  ...
  {
    id: "005",
    name: "超級運動公園 (Super Sports Park)",
    nameEn: "Super Sports Park",
    category: "playhouse",
    district: "大角咀",
    region: "kowloon",
  ...
  },
  {
    id: "006",
    name: "樂高探索中心",
    nameEn: "LEGOLAND Discovery Centre",
    category: "museum",
    district: "尖沙咀",
    region: "kowloon",
  ...
  {
    id: "008",
    name: "慧兒遊樂室 (Wise-Kids)",
    nameEn: "Wise-Kids Playroom",
    category: "playhouse",
    district: "中環/銅鑼灣",
    region: "hk-island",
    address: "中環/銅鑼灣均有分店",
  ...
  },
  {
    id: "011",
    name: "歡樂城運動香港",
    nameEn: "JOYPOLIS SPORTS",
    category: "playhouse",
    district: "啟德",
    region: "kowloon",
    address: "G/F-4/F, Health and Wellness Centre, Kai Tak Sports Park, 啟德",
    lat: 22.3260,
    lng: 114.1980,
    ageRange: [3, 12],
    indoor: true,
    ...
    priceDescription: "$200-400/人",
    phone: "",
    website: "https://hk-joypolis-sports.com/",
    description: "運動娛樂綜合體，融合科技及娛樂，設有忍者課程、VR 運動及 Sonic 主題區。",
    tips: "啟德體育園最新設施"
  },
  {
    id: "012",
    name: "潘美拉探索空間",
    nameEn: "Pamela Peck Discovery Space",
    category: "playhouse",
    district: "鴨脷洲",
    region: "hk-island",
    address: "G/F, 2 Tin Wan Hill Road, Tin Wan, 鴨脷洲",
    lat: 22.2460,
    lng: 114.1490,
    ageRange: [0, 6],
    indoor: true,
    ...
    rainyDaySuitable: true,
    openingHours: "請查詢官方網站",
    priceDescription: "$0-100/人",
    phone: "",
    website: "https://discoveryspace.yccece.edu.hk/",
    description: "探索空間，設有香港主題角色扮演、攀岩及指導自由遊樂。",
    tips: "有室外區域"
  },
  {
    id: "013",
    ...
    priceDescription: "$100-200/人",
    phone: "",
    website: "https://www.mygym.com.hk/",
    description: "健身中心，設有體操、鞦韆、翻滾及主題課程以建立自信。",
    tips: "注重體能發展"
  },
  {
    id: "014",
    ...
    district: "上環",
    region: "hk-island",
    address: "2/F, Workington Tower, 78 Bonham Strand, 上環",
    lat: 22.2870,
    lng: 114.1500,
    ageRange: [1, 6],
    indoor: true,
    ...
    priceDescription: "$100-200/人",
    phone: "",
    website: "https://www.casita.hk/",
    description: "社區遊樂中心，設有自由遊樂、音樂及感官課程於包容空間。",
    tips: "社區導向"
  },
  {
    id: "015",
    name: "大事物 (The Big Things)",
    nameEn: "The Big Things",
    category: "playhouse",
    district: "荃灣",
    region: "nt",
    address: "Shop 205-207, 2/F, The Mills, 45 Pak Tin Par Street, 荃灣",
    lat: 22.3756,
    lng: 114.1094,
    ageRange: [1, 6],
    indoor: true,
    ...
    priceDescription: "$100-200/人",
    phone: "3619 0633",
    website: "https://www.thebigthings.com/",
    description: "自然主題叢林公園，設有火山、沼澤及動物感官遊樂。",
    tips: "記得帶襪"
  }
];
